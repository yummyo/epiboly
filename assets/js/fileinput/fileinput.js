...
(function (factory) {
    ...
    $h = {
        ...
        objUrl: window.webkitURL || window.URL,
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document">\n' +
                ...
                '      <div class="kv-zoom-actions">{left}{right}{toggleheader}{fullscreen}{borderless}{close}</div>\n' +
                '    </div>\n' +
        ...
        _rotateImg: function (type) {
            // type true 顺时针旋转 false 逆时针旋转
            var self = this, $modal = self.$modal,
                $img = $modal.find('.kv-zoom-body'),
                _rotate = $img.css('transform'),_deg;
            if(!_rotate || _rotate == "none"){
                _deg = 0;
            }else{
                _deg = eval("self._get"+_rotate);
            }
            _deg = eval(_deg + `${type?"+":"-"}90`);
            if(_deg==360) _deg=0;
            $img.css("transform",`rotate(${_deg}deg)`);
        },
        _getmatrix : function(a,b,c,d,e,f){
        ...
        _setZoomContent: function ($frame, animate) {
            var self = this, $content, tmplt, body, title, $body, $dataEl, config, pid = $frame.attr('id'),
                $modal = self.$modal, $prev = $modal.find('.btn-prev'), $next = $modal.find('.btn-next'),
                $left = $modal.find('.btn-left'),$right = $modal.find('.btn-right'), $tmp,
            ...
            self._handler($left, 'click', function () {
                self._rotateImg(false);
            });
            self._handler($right, 'click', function () {
                self._rotateImg(true);
            });
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            left: '<i class="iconfont icon-zuoxuanzhuan"></i>',
            right: '<i class="iconfont icon-youxuanzhuan"></i>',
        ...
        previewZoomButtonClasses: {
            ...
            left: 'btn btn-kv btn-default btn-outline-secondary',
            right: 'btn btn-kv btn-default btn-outline-secondary',
