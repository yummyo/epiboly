$(function() {
    ...
    function n() {
        ...
        if ($(".J_menuTab").each(function() {
            ...
            var s = '<a href="javascript:;" class="active J_menuTab" data-id="' + t + '">' + i + ' <i class="icon iconfont">&#xea09;</i></a>';
    ...
    $("#main-nav .nav_menus").on("click",".J_menuItem",n),
	$("#wrapper,#scroll_slide").on("click",".J_menuItem",n),
